  ...
  if (error || !data) {
    return (
      <div className="min-h-screen bg-stone-950 flex flex-col items-center justify-center p-6 text-center text-white space-y-4">
        ...
        <Button onClick={() => setLocation("/")} className="bg-brand-600 hover:bg-brand-700 text-white rounded-xl">
          Retour à l'accueil
        </Button>
      </div>
    );
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-stone-200 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-stone-100 pb-6">
            <div className="space-y-1">
              <span className="inline-block px-3 py-1 rounded-full bg-brand-50 text-brand-800 text-xs font-bold uppercase tracking-wider">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button 
                ...
                className="bg-brand-600 hover:bg-brand-700 text-white shrink-0 text-xs">
            ...
            <div className="bg-brand-50/60 border border-brand-200 rounded-2xl p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-stone-700">
                <div className="bg-white p-4 rounded-xl border border-brand-100 space-y-1">
                  <p className="font-bold text-stone-900 flex items-center gap-1.5"><Calendar className="w-4 h-4 text-brand-700" /> Créneau choisi</p>
                  <p>{latestResponse.day}</p>
                </div>
                <div className="bg-white p-4 rounded-xl border border-brand-100 space-y-1">
                  <p className="font-bold text-stone-900 flex items-center gap-1.5"><Utensils className="w-4 h-4 text-brand-700" /> Menu choisi</p>
